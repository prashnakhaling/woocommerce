...
//messagebox 
add_action('woocommerce_before_add_to_cart_button', 'add_custom_message_field_for_cakes');

function add_custom_message_field_for_cakes() {
    global $product;
    if ( has_term('cake', 'product_cat', $product->get_id()) ) { // Check if the product is in the 'cake' category
